...
\Lcs{fi}
\end{BDef}
\subsection{For either \LuaTeX\ or \XeTeX}
\begin{BDef}
\Lcs{ifLuaOrXeTeX}\\
\qquad\Larga{material for either \LuaTeX\ or \XeTeX}\\
\Lcs{else}\\
\qquad\Larga{material for neither \LuaTeX\ nor \XeTeX}\\
\Lcs{fi}
\end{BDef}
...
\subsection{For either \LuaTeX\ or \XeTeX}
\begin{BDef}
\Lcs{RequireLuaOrXeTeX}
\end{BDef}
This command tests for either \LuaTeX\ or \XeTeX\ use and throws an error if a different engine is being used.
\end{document}